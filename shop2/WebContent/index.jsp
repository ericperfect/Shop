		  ...
		  <div class="modal-dialog modal-lg" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        ...
		        <h4 class="modal-title" id="myModalLabel">智能推荐商品</h4>
		      </div>
		      <div class="modal-body">
		        	...
		        	<div class="row">
		        		<c:forEach items="${proList}" var="pro">
							...
							<a href="${pageContext.request.contextPath }/productInfo?pid=${pro.pid}&cid=${pro.cid}&currentPage=1">
								<img src="${pro.pimage }" width="170" height="170" style="display: inline-block;">
							</a>
							<p>
								<a href="${pageContext.request.contextPath}/productInfo?pid=${pro.pid}&cid=${pro.cid}&currentPage=1" style='color: green'>${pro.pname }</a>
							</p>
							<p>
		      ...
		      <div class="modal-footer">
		        <button id="myBtn" onclick="close()" type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		      </div>
		    </div>
		  </div>
		</div>
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<a href="http://localhost:8080/shop/productInfo?pid=123&cid=1&currentPage=1"><img src="img/1.png" width="100%"></a>
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProductList }" var="hotPro">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/productInfo?pid='${hotPro.pid }'&cid='${hotPro.cid}'&currentPage=1">
								<img src="${pageContext.request.contextPath }/${hotPro.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="#" style='color:#666'>${hotPro.pname }</a></p>
