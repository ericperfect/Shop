...
<script type="text/javascript">
	function addCart(){
		...
		location.href = "${pageContext.request.contextPath}/addCart?pid=${pro.pid}&buyNum="+buyNum;
	}
</script>
</head>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath}/index">首页&nbsp;&nbsp;&gt;</a> <a href="${pageContext.request.contextPath}/productListByCid?cid=${pro.cid}">${pro.category.cname}&nbsp;&nbsp;&gt;</a>
				<a>${pro.pname}</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						商城价: <strong style="color: #ef0101;">￥:${pro.shop_price }</strong> 市场价：
						<del>￥:${pro.market_price}元</del>
					</div>
					...
					<div>
						<a href="${pageContext.request.contextPath}/productListByCid?cid=${cid}&currentPage=${currentPage}">返回上一列表</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
