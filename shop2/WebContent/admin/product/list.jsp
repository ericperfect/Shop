...
<script type="text/javascript">
			...
			function editProduct(pid){
					window.location.href = "${pageContext.request.contextPath}/editProduct?pid="+pid;
			}
</script>
</HEAD>
<body>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${productList }" var="pro" varStatus="vs">
								...
								<td align="center" style="HEIGHT: 22px">
									<a href="javascript:;" onclick="editProduct('${pro.pid}')">
										<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0" style="CURSOR: hand">
									</a>
								</td>

								<td align="center" style="HEIGHT: 22px">
									<a href="javascript:;" onclick="delPro('${pro.pid}')">
										<img
