		...
		<script type="text/javascript">
			...
			function findOrderInfoByOid(oid){
				...
				$.post(
					...
					function(data){
						  /* [
						   	{"pimage":"products/1/iphone_8_Plus.png","shop_price":6888.0,"pname":"苹果8Plus","subtotal":6888.0,"count":1}
						  ] */
						  var content="";
        ...
        <div id="showDiv" class="blk" style="display:none;">
            <div class="main">
                ...
                <div id="loading" style="padding-top:30px;text-align: center;">
                	<img alt="" style="height:220px;width:220px;" src="${pageContext.request.contextPath }/images/loading.gif">
                </div>
				<div id="kobe" style="padding:20px;">
